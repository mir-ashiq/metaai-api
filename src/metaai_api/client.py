...
def send_animate_request(user_cookie_header: str, prompt: str) -> str:
    cookies = parse_cookie_header(user_cookie_header)
    ...
    headers = {
        ...
        "origin": "https://www.meta.ai",
        "priority": "u=1, i",
        "referer": "https://www.meta.ai/prompt/49663068-d918-49c2-8ba5-b433fe2490e9",
        "sec-ch-ua": '"Brave";v="141", "Not?A_Brand";v="8", "Chromium";v="141"',
        "sec-ch-ua-full-version-list": '"Brave";v="141.0.0.0", "Not?A_Brand";v="8.0.0.0", "Chromium";v="141.0.0.0"',
        "sec-ch-ua-mobile": "?0",
        "sec-ch-ua-model": '""',
    ...
    variables = '{"message":{"sensitive_string_value":"' + prompt.replace("\"", "\\\"") + '"}}'
    ...
    data = {
        ...
        "__hsi": (None, "7574782986293208112"),
        "__dyn": (None, "7xeUjG1mxu1syUqxemh0no6u5U4e2C1vzEdE98K360CEbo19oe8hw2nVEtwMw6ywaq221FwpUO0n24oaEnxO0Bo7O2l0Fwqo31w9O1lwlE-U2zxe2GewbS361qw82dUlwhE-15wmo423-0j52oS0Io5d0bS1LBwNwKG0WE8oC1IwGw-wlUcE2-G2O7E5y1rwa211wo84y1ix-0QU4G"),
        "__csr": (None, "gakn75aDdliH9qOuJmDOnQ-KGCXlqrl8Hp9QHAA8EWmih2EcHyGzax24UqxGewOU8oKbwi84N4Cp801sJ4Qi1zCwvo0Jsqp2Ygdy40E4N1RGNE2b2SguE5x0mVem94adwwBg3fCty8qw5gwIw1Ca0xU8U179aAAw4pKU2uK5o4G0gm0X81Y8kgn5QU0gEy9hM16US322Gt0Hw9t7Cleu8wWykbwh80k2S13wp-0UA4o9oF009f13GhU7t0da5d5g728g2Gw"),
        "__hsdp": (None, "gcSIb71ug8OhG7lnsAXicOqi8xtEjB4RhitBSx2rIwGtogxmAbgixZ0k5h9V8a9QmbUqyEswfe0Ro2Mg4aQ13wHwVwlo5Obwno8UuwoU32wUwgE"),
        "__hblp": (None, "08W5EWA3im4Sih3pecSP1pzELDyUKsxrCQGz5gFBybAxFbbzodRBDACwxDhpG_xyaxO0xGw4_wAyE6y5Q12J0gU9XwVwKwCAwEw9y2euK445Gwi411wGxa12xi58Cibx51C9G3W"),
        "__sjsp": (None, "gcSL6jD1ug8OhG7lnsAXiij9Dqg-TVx2ynSnAkHAJ0oE"),
        "__comet_req": (None, "72"),
        "fb_dtsg": (None, "NAfs8i5CfuTxSgY049krPWfh6MLk1zW--f6qnzvqgeEaPvOWcpH_esA:2:1763623145"),
        "jazoest": (None, "25561"),
        "lsd": (None, "MMUBfnMuJ_zHq68M_QsA9p"),
